...
if (!file.exists(paste0(location, "/tract_outcomes_early.csv"))) {
  download.file(url = "https://opportunityinsights.org/wp-content/uploads/2018/10/tract_outcomes.zip", paste0(location, "/opportunity_outcomes.zip"))

  unzip(zipfile = paste0(location, "/opportunity_outcomes.zip"), exdir = location)

  opportunity_data <- read.csv(paste0(location, "/tract_outcomes_early.csv"))
} else {
  opportunity_data <- read.csv(paste0(location, "/tract_outcomes_early.csv"))
}
